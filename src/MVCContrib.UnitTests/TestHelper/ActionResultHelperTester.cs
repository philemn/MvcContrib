...
namespace MvcContrib.UnitTests.TestHelper
{
    ...
    public class ActionResultHelperTester
    {
        ...
        [Test]
        public void ForView_For_PartialViewResult_Should_Return_Source_Result()
        {
            var result = new PartialViewResult { ViewName = "Index" };
            var final = result.ForView("Index");
            Assert.That(final, Is.EqualTo(result));
        }

        [Test, ExpectedException(typeof(ActionResultAssertionException), ExpectedMessage = "Expected partial view name 'Index', actual was 'About'")]
        public void ForView_For_PartialViewResult_Should_Throw_If_View_Names_Do_Not_Match()
        {
            var result = new PartialViewResult { ViewName = "About" };
            result.ForView("Index");
        }
        ...
        [Test]
        public void WithViewData_On_PartialViewResult_Should_Return_View_Data_If_View_Data_Type_Is_Subclass_Of_Expected_Type()
        {
            var expectedData = new DerivedCustomViewData { ID = 2, Name = "Foo" };
            var renderResult = new PartialViewResult { ViewData = new ViewDataDictionary(expectedData) };
